  ...
  return (
    <div className='section-padding'>
      ...
      <p className="text-[23px]">
        ...
        consectetur, blanditiis in beatae. Nihil animi illo nesciunt reiciendis!
        Voluptas accusamus commodi sed consectetur, iste recusandae porro error,
        ab, odit debitis perspiciatis facilis. Perferendis, voluptatibus?
