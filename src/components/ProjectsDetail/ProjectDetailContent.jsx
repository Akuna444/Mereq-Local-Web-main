...
const ProjectDetailContent = () => {
  return (
    <div className="section-padding">
      <div className="w-full grid gap-10 grid-cols-3 section-padding-top">
        <div className="w-full flex flex-col gap-4">
          ...
          <h3 className="px-4 text-tertiary">Lorem Ipsum</h3>
        </div>
        <div className="w-full flex col-span-2 flex-col gap-4">
