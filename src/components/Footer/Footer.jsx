const Footer = () => {
  return (
    <div className="section-padding px-[110px] bg-gradient-to-tr from-[20%] to-[80%] from-[#1c003d] to-[#1d5978] text-white">
      ...
      <div className="flex md:flex-row flex-col justify-between py-8 w-full">
