...
const Hero = () => {
  return (
    <div className=" section-padding  relative">
      <div className="bg-[#300083] opacity-50 dark:opacity-100 absolute  left-[0] w-[400px] h-[400px] top-[-140px] z-[-1] rounded-full blur-[90px] "></div>
      <div className="bg-[#300083] opacity-10 dark:opacity-100 absolute  right-[0] h-[600px] top-[100px] z-[-1] w-[600px] rounded-full blur-[90px]"></div>

      <div className="grid grid-cols-1 md:gap-0 gap-12 md:grid-cols-2 ">
